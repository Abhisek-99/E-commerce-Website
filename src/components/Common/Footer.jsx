    ...
    <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0">
        <div>
            ...
            <form className="flex">
                ...
                <button type="submit" className="bg-black text-white px-6 py-3 text-sm rounded-r-md hover:bg-red-600 transition-all">Subscriber</button>
            </form>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-600">
            <li>
              <Link to="/products" className="hover:text-gray-800 transition-colors">Men's Top Wear</Link>
            </li>
            <li>
              <Link to="/products" className="hover:text-gray-800 transition-colors">Women's Top Wear</Link>
            </li>
            <li>
              <Link to="/products" className="hover:text-gray-800 transition-colors">Men's Bottom Wear</Link>
            </li>
            <li>
              <Link to="/products" className="hover:text-gray-800 transition-colors">Women's Bottom Wear</Link>
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <p>
            ...
            <a href="tel:+1234567890" className='text-gray-600 hover:text-gray-800'>+91 988 305 4901</a>
          </p>
          </div>
    </div>
    {/* footer Bottom */}
    <div className="container mx-auto mt-12 px-4 lg:px-0 border-t border-gray-200 pt-6">
      <p className='text-gray-500 text-sm tracking-tighter text-center'>&copy; 2025, Abhisek, All rights reserved.</p>
    </div>
  </footer>
};
