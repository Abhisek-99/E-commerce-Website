...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="container mx-auto flex items-center justify-between py-4 px-6">
        ...
        <div>
          {/* <Link to="/" className="text-2xl font-medium"> */}
            <img src={logo} alt="business_logo" className='w-15 h-10'/>
          {/* </Link> */}
        </div>
      ...
      <div className={`fixed top-0 left-0 w-3/4 h-full bg-white shadow-lg transform transition-transform duration-300 z-50 ${navDrawerOpen ? 'translate-x-0' : '-translate-x-full'}`}>
