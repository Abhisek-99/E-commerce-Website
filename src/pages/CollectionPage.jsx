...
const CollectionPage = () => {
    ...
    return (
        <div className='flex flex-col lg:flex-row'>
            ...
            {/* Filter Sidebar */}
            <div ref={sidebarRef} className={`${isSidebarOpen ? "transition-x-0" : "-translate-x-full"} fixed inset-y-0 z-50 left-0 w-64 bg-white overflow-y-auto transition-transform duration-300 lg:static lg:translate-x-0`} >
                <FilterSidebar />
            </div>
